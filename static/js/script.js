document.addEventListener('DOMContentLoaded', () => {
    ...
    const shirtImage = "{{ url_for('static', filename='images/white_shirt_only.png') }}"; // The image for the shirt
    const pantImage = "{{ url_for('static', filename='images/pant_only.png') }}"; // The image for the pants
    const combinedImage = "{{ url_for('static', filename='images/shirt-pant.png') }}"; // The image to show when both checkboxes are checked
